        ...
        <div className="navbar-custom">
            <ul className="list-unstyled topnav-menu float-end mb-0">
                ...
                >
                    <div className=" ">
                        <div
                            className="d-flex gap-0 align-items-center justify-content-center hidden"
                            hidden
                        >
            ...
            >
                <a href="/" className="logo text-center">
                    <span className="logo-sm">
                        <img src="/assets/img/favicon.png" alt="" height="14" />
                    </span>
                    <span className="logo-lg">
                        <img src="/assets/img/logo.png" alt="" height="24" />
                    </span>
                </a>
            </div>
