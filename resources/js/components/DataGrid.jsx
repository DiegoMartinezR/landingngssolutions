...
const DataGrid = ({ gridRef: dataGridRef, pageSize = 10, rest, columns, toolBar, masterDetail, filterValue, exportable, exportableName, extraParams = {}, customizeCell = () => { } }) => {
  useEffect(() => {
    ...
    $(dataGridRef.current).dxDataGrid({
      ...
      dataSource: {
        load: async (params) => {
          const data = await rest.paginate({ ...params, ...extraParams, _token: $('[name="csrf-token"]').attr('content') })
          return data
        },
      },
