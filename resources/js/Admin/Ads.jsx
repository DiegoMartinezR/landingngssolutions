...
const Ads = () => {
    ...
    const onModalOpen = (data) => {
        ...
        if (data?.invasivo) {
            $(invasivoRef.current).prop("checked", true).trigger("change");
        } else {
            $(invasivoRef.current).prop("checked", false).trigger("change");
        }
...
CreateReactScript((el, properties) => {
    createRoot(el).render(
        <BaseAdminto {...properties} title="Promo Banners & Ads">
            <Ads {...properties} />
        </BaseAdminto>
    );
});
