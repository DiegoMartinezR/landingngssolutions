...
const Services = ({ brands }) => {
    ...
    const onModalOpen = (data) => {
        ...
        formTypeRef.current.value = data?.form_type || "";
    ...
    const onModalSubmit = async (e) => {
        ...
        formData.append("form_type", formTypeRef.current.value);
                ...
                columns={[
                    ...
                    /*{
                        ...
                        cellTemplate: (container, { data }) => {
                            ...
                            container.text(types[data.form_type] || "Ninguno");
                        },
                    },*/
                    {
                        dataField: "title",
                ...
                <div className="row">
                    <div className="col-md-6">
                        ...
                        <div className="mb-3" hidden>
                            ...
                            <select ref={formTypeRef} className="form-select">
