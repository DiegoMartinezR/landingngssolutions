...
const Thanks = ({ session }) => {
    ...
    return (
        <>
            <Header />
            <div className="flex bg-primary flex-col items-center justify-center min-h-screen px-5 py-10">
                <motion.div
                    initial="hidden"
                    animate="visible"
                ...
                >
                    ...
                    <motion.div
                        variants={itemVariants}
                        className="w-20 h-1 bg-gradient-to-r from-blue-600 to-primary rounded-full mb-6"
                    />
                    ...
                    >
                        We have received your message correctly. Our team will
                        review your request and we will contact you as soon as
                        possible.
                    </motion.p>
                    ...
                    <motion.button
                        ...
                        className="px-8 py-3 bg-gradient-to-r from-blue-600 to-primary text-white font-medium rounded-lg hover:shadow-md transition-all duration-200"
                    >
                        {t("public.header.home", "Home")}
                    </motion.button>
                </motion.div>
            </div>
            <Footer />
