...
Route::get('/certifications/media/{uuid}', [App\Http\Controllers\CertificationController::class, 'media']);
...
Route::get('/zone/media/{uuid}', [AdminZoneController::class, 'media']);
...
Route::post('/track-visit', [App\Http\Controllers\VisitController::class, 'track']);
...
Route::middleware('auth')->group(function () {
    ...
    Route::middleware('can:Admin')->prefix('admin')->group(function () {
        ...
        Route::post('/generals/upload', [AdminGeneralController::class, 'upload']);
        ...
        Route::put('/facilities/{id}/reorder', [AdminFacilityController::class, 'reorder']);
        ...
        Route::put('/zones/{id}/reorder', [AdminZoneController::class, 'reorder']);
