...
Route::get('/videos/video/{uuid}', [AdminVideoController::class, 'video']);
...
Route::get('/offices/{slug}', [FacilityController::class, 'reactView'])->name('ZoneFacilitiesPage.jsx');
Route::get('/cleaning-services/{slug}', [FacilityDetailController::class, 'reactView'])->name('FacilityDetailPage.jsx');
...
// Policy routes
Route::get('/privacy-policy', [PolicyController::class, 'privacy'])->name('PrivacyPolicy.jsx');
Route::get('/terms-and-conditions', [PolicyController::class, 'terms'])->name('TermsConditions.jsx');
Route::get('/cookies-policy', [PolicyController::class, 'cookies'])->name('CookiesPolicy.jsx');
Route::get('/copyright-notice', [PolicyController::class, 'copyright'])->name('CopyrightNotice.jsx');
Route::get('/return-and-shipping-policy', [PolicyController::class, 'exchange'])->name('ReturnShippingPolicy.jsx');
...
Route::middleware(['can:Admin', 'auth'])->prefix('admin')->group(function () {
    ...
    Route::get('/zones', [AdminZoneController::class, 'reactView'])->name('Admin/Zones.jsx');
